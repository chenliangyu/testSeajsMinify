complete example for using [grunt-seajs-converter](http://github.com/chenliangyu/grunt-seajs-converter) and [grunt-seajs-concat](http://github.com/chenliangyu/grunt-seajs-concat);
...
```
copy the example to you workspace
run 
```js
npm install
grunt 
